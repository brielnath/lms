...
$string['loginlogo_desc'] = 'Logo on the login page only (icon/emblem recommended, without university name). Navbar logo is not changed. PNG with transparent background works best.';
$string['media'] = 'Media';
